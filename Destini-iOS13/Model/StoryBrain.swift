...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) -> Int{
        let topChoice = storyNumber[nextStory].choice1
        
        if(userChoice == topChoice){
            nextStory = storyNumber[nextStory].choice1Destination
            return nextStory
        }else{
            nextStory =  storyNumber[nextStory].choice2Destination
            return nextStory
        }
    }
